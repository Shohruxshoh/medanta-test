    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'Direktor'), (3, 'Shifokor'), (2, 'Hamshira'), (4, 'Qabulxona'), (5, 'Hisobchi'), (0, 'Administratsiya'), (6, 'Menejer'), (7, 'Bemor'), (8, 'Hamkor'), (9, "Ko'z oynak")], default=7, verbose_name='Foydalanuvchi roli')),
                ...
                ('phone', models.CharField(blank=True, max_length=12, null=True, unique=True, verbose_name='Tel raqam')),
                ...
                ('is_operation', models.BooleanField(blank=True, default=False)),
                ...
                ('clinic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='user.clinic')),
