...
from .views import PatientComeHistoryCreateView, SearchCardIdView, CreateCardIdView, Home, historyView, \
    ...
    QRCodePartnerListView, qr_register_code, qr_partner_register_code, qr_gen, success, qr_code_second_generator

app_name = 'patient'

urlpatterns = [
    path('', Home.as_view()),
    path('qr/', qr_gen, name='qr'),
    path('qr-second/<int:pk>', qr_code_second_generator, name='qr-second'),
    ...
    path('card-id/<str:clinicId>/<str:cardId>', historyView, name='card-id'),
    path('register/<str:clinicId>/<str:cardId>', QRCodeRegisterView.as_view(), name='qr-register'),
